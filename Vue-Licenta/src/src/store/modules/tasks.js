...
const getters = {
    ...
    pozitiiIntermediare:(state) => state.pozitiiIntermediare
...
const mutations = {
    ...
    SOCKET_ONMESSAGE(state, message) {
        console.log('!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!',message)
        if(state.pozitiiIntermediare.lat === ''){
            state.pozitiiIntermediare.lat = message
            console.log('mesajul este', state.pozitiiIntermediare.lat)
        }
        else{
            state.pozitiiIntermediare.lng = message
            console.log('mesajul este', state.pozitiiIntermediare.lng)
        }
...
const actions = {
    ...
    getAllCars: ({ commit }) => {
        return axios.get('https://localhost:8082/cars')
            .then((response) => {
