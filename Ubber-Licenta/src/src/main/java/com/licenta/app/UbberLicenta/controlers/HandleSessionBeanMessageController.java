...
public class HandleSessionBeanMessageController {
    ...
    public SessionForAUser getApplicationScopeSessionMessage() {
        ...
        System.out.println(sessionBean.listSessionsForUsers+"aici afisez prima lista!!!!!!!!!!!!!!!!!!!!!!!!!!");
        ...
        for (int i = 0; i < seesionNotificationHandler.sessions.size(); i++) {
            ...
            for (int j = 0; j < mySessionList.size(); j++) {
                ...
                System.out.println("...............................");
                System.out.println(sessionBean.listSessionsForUsers.get(i).getSesiune().substring(28, 64));
                System.out.println(mySessionList.get(j));
                System.out.println(sessionBean.listSessionsForUsers.get(i).getSesiune().substring(28, 64));
                System.out.println(seesionNotificationHandler.getSessionId());
                if (sessionBean.listSessionsForUsers.get(i).getSesiune().substring(28, 64).equals(mySessionList.get(j))
                        ) {
                    System.out.println("am intrat ");
                    semaforBean.setSchimba(1);
                    System.out.println(semaforBean.getSchimba()+ "am schimbat ");
        ...
        System.out.println(semaforBean.getSchimba()+ "inainte de iesire");
        return null;
    }
